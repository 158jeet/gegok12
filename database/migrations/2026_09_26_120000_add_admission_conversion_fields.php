...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('tagore_admission_leads', function (Blueprint $table) {
            ...
            $table->index(['institution_id', 'status', 'converted_at']);
            $table->index(['institution_id', 'assigned_to', 'last_contacted_at']);
        });
    }
    ...
    {
        Schema::table('tagore_admission_leads', function (Blueprint $table) {
            $table->dropIndex(['institution_id', 'status', 'converted_at']);
            $table->dropIndex(['institution_id', 'assigned_to', 'last_contacted_at']);
